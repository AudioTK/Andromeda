...
class StaticFilter final: public ATK::ModellerFilter<double>
{
  ...
  ATK::StaticEBNPN<DataType> q2{1e-12,0.026,1,1,100,};
...
bool iterate() const
{
   ...
   auto  i0_= input_state[0];
    ...
    auto eq0 = + (pspectrumr17_trimmer != 0 ? (d1_ - d0_) / (pspectrumr17_trimmer * pspectrumr17) : 0) - r13.get_current(d6_, d0_) - (steady_state ? 0 : c10.get_current(d6_, d0_));
    auto eq1 = + (pspectrumr17_trimmer != 0 ? (d0_ - d1_) / (pspectrumr17_trimmer * pspectrumr17) : 0) + (pspectrumr17_trimmer != 1 ? (d2_ - d1_) / ((1 - pspectrumr17_trimmer) * pspectrumr17) : 0) + (steady_state ? 0 : c12.get_current(d1_, d5_)) + (steady_state ? 0 : c11.get_current(d1_, s0_));
    auto eq2 = + (pspectrumr17_trimmer != 1 ? (d1_ - d2_) / ((1 - pspectrumr17_trimmer) * pspectrumr17) : 0) + r19.get_current(d2_, s0_) + (steady_state ? 0 : c14.get_current(d2_, d7_)) + r20.get_current(d2_, d7_);
    auto eq3 = - q2.ib() + r16.get_current(d3_, s1_) - (steady_state ? 0 : c13.get_current(d5_, d3_)) + r15.get_current(d3_, s0_);
    auto eq4 = + q2.ib() + q2.ic() + r14.get_current(d4_, d5_);
    auto eq5 = + (steady_state ? 0 : c13.get_current(d5_, d3_)) - (steady_state ? 0 : c12.get_current(d1_, d5_)) - r14.get_current(d4_, d5_);
    auto eq6 = + r13.get_current(d6_, d0_) + (steady_state ? 0 : c10.get_current(d6_, d0_)) - r11.get_current(d8_, d6_) + r18.get_current(d6_, s0_);
    ...
    auto eq9 = + r12.get_current(d9_, s0_) + (steady_state ? 0 : c9.get_current(d9_, s0_)) - (steady_state ? 0 : c8.get_current(d8_, d9_));
    ...
    auto jac0_0 = 0 + (pspectrumr17_trimmer != 0 ? -1 / (pspectrumr17_trimmer * pspectrumr17) : 0) - r13.get_gradient() - (steady_state ? 0 : c10.get_gradient());
    ...
    auto jac1_1 = 0 + (pspectrumr17_trimmer != 0 ? -1 / (pspectrumr17_trimmer * pspectrumr17) : 0) + (pspectrumr17_trimmer != 1 ? -1 / ((1 - pspectrumr17_trimmer) * pspectrumr17) : 0) - (steady_state ? 0 : c12.get_gradient()) - (steady_state ? 0 : c11.get_gradient());
    ...
    auto jac2_2 = 0 + (pspectrumr17_trimmer != 1 ? -1 / ((1 - pspectrumr17_trimmer) * pspectrumr17) : 0) - r19.get_gradient() - (steady_state ? 0 : c14.get_gradient()) - r20.get_gradient();
    auto jac2_3 = 0;
    auto jac2_4 = 0;
    auto jac2_5 = 0;
    auto jac2_6 = 0;
    ...
    auto jac3_1 = 0;
    auto jac3_2 = 0;
    auto jac3_3 = 0 - q2.ib_Vbc() - q2.ib_Vbe() - r16.get_gradient() - (steady_state ? 0 : c13.get_gradient()) - r15.get_gradient();
    ...
    auto jac5_5 = 0 - (steady_state ? 0 : c13.get_gradient()) - (steady_state ? 0 : c12.get_gradient()) - r14.get_gradient();
    auto jac5_6 = 0;
    auto jac5_7 = 0;
    auto jac5_8 = 0;
    auto jac5_9 = 0;
    ...
    auto jac6_4 = 0;
    auto jac6_5 = 0;
    auto jac6_6 = 0 - r13.get_gradient() - (steady_state ? 0 : c10.get_gradient()) - r11.get_gradient() - r18.get_gradient();
    auto jac6_7 = 0;
    ...
    auto jac9_9 = 0 - r12.get_gradient() - (steady_state ? 0 : c9.get_gradient()) - (steady_state ? 0 : c8.get_gradient());
    auto jac9_10 = 0;
    auto jac10_0 = 0;
    auto jac10_1 = 0;
    auto jac10_2 = 0;
    ...
    jacobian << jac0_0, jac0_1, jac0_2, jac0_3, jac0_4, jac0_5, jac0_6, jac0_7, jac0_8, jac0_9, jac0_10
      , jac1_0, jac1_1, jac1_2, jac1_3, jac1_4, jac1_5, jac1_6, jac1_7, jac1_8, jac1_9, jac1_10
      , jac2_0, jac2_1, jac2_2, jac2_3, jac2_4, jac2_5, jac2_6, jac2_7, jac2_8, jac2_9, jac2_10
      , jac3_0, jac3_1, jac3_2, jac3_3, jac3_4, jac3_5, jac3_6, jac3_7, jac3_8, jac3_9, jac3_10
      , jac4_0, jac4_1, jac4_2, jac4_3, jac4_4, jac4_5, jac4_6, jac4_7, jac4_8, jac4_9, jac4_10
      , jac5_0, jac5_1, jac5_2, jac5_3, jac5_4, jac5_5, jac5_6, jac5_7, jac5_8, jac5_9, jac5_10
      , jac6_0, jac6_1, jac6_2, jac6_3, jac6_4, jac6_5, jac6_6, jac6_7, jac6_8, jac6_9, jac6_10
      , jac7_0, jac7_1, jac7_2, jac7_3, jac7_4, jac7_5, jac7_6, jac7_7, jac7_8, jac7_9, jac7_10
      , jac8_0, jac8_1, jac8_2, jac8_3, jac8_4, jac8_5, jac8_6, jac8_7, jac8_8, jac8_9, jac8_10
      , jac9_0, jac9_1, jac9_2, jac9_3, jac9_4, jac9_5, jac9_6, jac9_7, jac9_8, jac9_9, jac9_10
      , jac10_0, jac10_1, jac10_2, jac10_3, jac10_4, jac10_5, jac10_6, jac10_7, jac10_8, jac10_9, jac10_10;
