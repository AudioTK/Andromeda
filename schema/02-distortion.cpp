...
bool iterate() const
{
   ...
   auto  i0_= input_state[0];
    ...
    auto eq0 = + (pgain_trimmer != 0 ? (d1_ - d0_) / (pgain_trimmer * pgain) : 0) + (steady_state ? 0 : c3.get_current(d0_, d2_)) - (steady_state ? 0 : r7c4.get_current(s0_, d0_)) + (pbassr8_trimmer != 1 ? (d3_ - d0_) / ((1 - pbassr8_trimmer) * pbassr8) : 0) + d1d2.get_current();
    auto eq1 = + (pgain_trimmer != 0 ? (d0_ - d1_) / (pgain_trimmer * pgain) : 0) + (pgain_trimmer != 1 ? (d2_ - d1_) / ((1 - pgain_trimmer) * pgain) : 0) - r6.get_current(d2_, d1_);
    auto eq2 = input_state[0] - dynamic_state[0];
    auto eq3 = + (pbassr8_trimmer != 1 ? (d0_ - d3_) / ((1 - pbassr8_trimmer) * pbassr8) : 0) - (steady_state ? 0 : c5.get_current(s0_, d3_));
    eqs << eq0, eq1, eq2, eq3;
    ...
    auto jac0_0 = 0 + (pgain_trimmer != 0 ? -1 / (pgain_trimmer * pgain) : 0) - (steady_state ? 0 : c3.get_gradient()) - (steady_state ? 0 : r7c4.get_gradient()) + (pbassr8_trimmer != 1 ? -1 / ((1 - pbassr8_trimmer) * pbassr8) : 0) - d1d2.get_gradient();
    ...
    auto jac1_1 = 0 + (pgain_trimmer != 0 ? -1 / (pgain_trimmer * pgain) : 0) + (pgain_trimmer != 1 ? -1 / ((1 - pgain_trimmer) * pgain) : 0) - r6.get_gradient();
    ...
    auto jac3_1 = 0;
    auto jac3_2 = 0;
    auto jac3_3 = 0 + (pbassr8_trimmer != 1 ? -1 / ((1 - pbassr8_trimmer) * pbassr8) : 0) - (steady_state ? 0 : c5.get_gradient());
    auto det = (-1 * jac0_1 * (-1 * jac1_2 * (1 * jac2_0 * jac3_3)) + 1 * jac0_2 * (-1 * jac1_1 * (1 * jac2_0 * jac3_3)));
    auto invdet = 1 / det;
    auto com0_0 = 0;
    ...
    auto com1_2 = -1 * (1 * jac0_0 * (1 * jac1_2 * jac3_3) + -1 * jac0_2 * (1 * jac1_0 * jac3_3) + 1 * jac0_3 * (-1 * jac1_2 * jac3_0));
    auto com2_2 = (1 * jac0_0 * (1 * jac1_1 * jac3_3) + -1 * jac0_1 * (1 * jac1_0 * jac3_3) + 1 * jac0_3 * (-1 * jac1_1 * jac3_0));
